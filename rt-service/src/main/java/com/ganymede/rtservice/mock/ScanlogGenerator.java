...
public class ScanlogGenerator {
	...
	private static Long[] userIds = new Long[]{1l, 2l, 3l, 4l, 5l, 6l, 7l, 8l, 9l, 10l, 11l, 12l, 13l, 14l, 15l,16l,17l,18l}; //用户id集合
	...
	private static String[] citys = new String[]{"Shanghai", "hangzhou", "beijing","guangzhou","shenzhen"}; // 地区-市集合
