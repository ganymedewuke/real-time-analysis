package com.ganymede.flink.sql;
...
public class TableSQL2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        DataSet<String> input = env.readTextFile("E:\\mygit\\flink-project\\real-time-analysis\\rt-analysis\\test.csv");
//        input.print();
...
//        tapiResult.printSchema();
        ...
        Table groupedByCountry = tableEnv.sqlQuery(
                "select club, count(distinct player) as sum_score from topScore group by club order by 2 desc limit 1");
