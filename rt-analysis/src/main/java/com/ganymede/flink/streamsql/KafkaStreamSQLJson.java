 ...
 *
 */
public class KafkaStreamSQLJson {
	public static void main(String[] args) throws Exception {
		...
		SingleOutputStreamOperator<UserScanLog> kafkaSource = topic.map(new MapFunction<KafkaMessage,UserScanLog>() {
			@Override
			public UserScanLog map(KafkaMessage value) throws Exception {
		...
		tEnv.registerDataStream("userScanLog", kafkaSource);


		Table result = tEnv.sqlQuery("(select * from userScanLog ");
